...
class AbilitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post abilities_url, params: { ability: { bool: @ability.bool, is_main_series: @ability.is_main_series, name: @ability.name } }
    end
  ...
  test "should update ability" do
    patch ability_url(@ability), params: { ability: { bool: @ability.bool, is_main_series: @ability.is_main_series, name: @ability.name } }
